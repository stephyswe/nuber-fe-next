export const storePageData = {
  image: '/images/store/cover-bg.webp',
  citySelected: {
  ...
  detail: {
    title: 'La Cantina',
    address: 'Ånäsvägen 48, Göteborg, Västra Götaland 416 68',
    timeCost: 'Open until 3:00 PM',
    info: 'Tap for hours, info and more',
    rating: '2.7 (50+ ratings) • American • $$',
  },
};
